...
-- Semantics:
-- * "new flight" = row first seen within NEW_WINDOW_HOURS (default 24h) from created_at/first_seen_at.
-- * no longer 'new' after NEW_WINDOW_HOURS pass.
-- * "removed" = flight previously active that is missing in current scrape; mark active=0 and set removed_at.
