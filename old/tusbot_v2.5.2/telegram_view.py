...
__file_version__ = "telegram_view.py@1"  # added 2025-08-30 00:15
...
def format_flight_card(f: dict) -> str:
    ...
    if link:
        lines.append(_rtl(f"<a href=\"{link}\"></a> · <code>{key}</code>"))
    else:
...
def main_menu_kb() -> InlineKeyboardMarkup:
    rows = [
        ...
        [InlineKeyboardButton("יעדים 🎯", callback_data="DESTS"),
         InlineKeyboardButton("מחיר מקסימלי 💸", callback_data="PRICE"),
